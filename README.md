...
- **L'Orchestrator LUA si blocca nei menu**: I nomi dei flussi interni della UI di Capcom (es. `app.menu.UIFlowTitle.Param`) possono subire variazioni a seguito di aggiornamenti o patch importanti di *Street Fighter 6*.
  In caso di blocchi post-aggiornamento, procedi in questo modo:
